...
class RecentSearchesFragmentUnitTest {
    ...
    fun setUp() {
        ...
        Whitebox.setInternalState(fragment, "searchesRepository", searchesRepository)
    ...
    @Throws(Exception::class)
    fun testOnResume() {
        whenever(searchesRepository.recentSearches(10)).thenReturn(mutableListOf("search1"))
        fragment.onResume()
    }
