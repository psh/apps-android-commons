...
class RecentLanguagesContentProviderUnitTest {
    ...
    fun testInsert() {
        ...
        contentProvider.insert(RecentLanguagesContentProvider.BASE_URI, mock(android.content.ContentValues::class.java))
    }

    @Test
    fun testUpdate() {
        `when`(database.update(any(), any(), any(), any(), any())).thenReturn(1)
        val uri = RecentLanguagesContentProvider.uriForCode("1")
    ...
    fun testDelete() {
        ...
        val uri = RecentLanguagesContentProvider.uriForCode("en")
