...
class BookmarkPicturesContentProviderUnitTest {
    private lateinit var contentProvider: BookmarkPicturesContentProvider
    ...
    fun setUp() {
        ...
        contentProvider = BookmarkPicturesContentProvider()
    ...
    fun testInsert() {
        ...
        contentProvider.insert(BookmarkPicturesContentProvider.BASE_URI, mock(android.content.ContentValues::class.java))
    }

    @Test
    fun testUpdate() {
        `when`(database.update(any(), any(), any(), any(), any())).thenReturn(1)
        val uri = BookmarkPicturesContentProvider.uriForName("1")
    ...
    fun testDelete() {
        ...
        val uri = BookmarkPicturesContentProvider.uriForName("en")
