...
abstract class UploadModule {
    ...
    @Binds
    abstract fun bindsCategoriesPresenter(
        presenter: CategoriesPresenter?
    ): CategoriesContract.UserActionListener?

    @Binds
    abstract fun bindsMediaLicensePresenter(
        presenter: MediaLicensePresenter?
    ): MediaLicenseContract.UserActionListener?

    @Binds
    abstract fun bindsUploadMediaPresenter(
        presenter: UploadMediaPresenter?
    ): UploadMediaDetailsContract.UserActionListener?

    @Binds
    abstract fun bindsDepictsPresenter(
        presenter: DepictsPresenter?
