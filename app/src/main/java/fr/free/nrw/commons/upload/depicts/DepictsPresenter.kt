...
class DepictsPresenter
    ...
    constructor(
        ...
        private fun searchResultsWithTerm(term: String): Flowable<Pair<List<DepictedItem>, String>> =
            searchResults(term).map { Pair(it, term) }
    ...
    override fun getUploads(): List<UploadItem> {
        ...
        override fun getDepictedItems(): LiveData<List<DepictedItem>> = depictedItems
         ...
         */
        private fun getRecentDepictedItems(): List<DepictedItem> =
            runBlocking {
