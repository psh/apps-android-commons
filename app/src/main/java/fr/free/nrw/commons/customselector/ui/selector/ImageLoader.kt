...
constructor(
    ...
    /**
     * UploadedStatus Repo for cache query.
     */
    var uploadedStatusRepository: UploadedStatusRepository,
    /**
    ...
    suspend fun nextActionableImage(
        ...
        for (i in nextImagePosition until allImages.size) {
            ...
            if (next > 0) {
                ...
                next = uploadedStatusRepository.findByImageSHA1(imageSHA1, true)
                ...
                if (next <= 0) {
                    ...
                    next =
                        uploadedStatusRepository.findByModifiedImageSHA1(
                            modifiedImageSha1,
                            true,
                        )
     ...
     */
    suspend fun getFromUploaded(imageSha1: String) =
        uploadedStatusRepository.getFromImageSHA1(imageSha1)
