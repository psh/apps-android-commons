...
class UploadController @Inject constructor(
    ...
    fun prepareMedia(contribution: Contribution) {
        ...
        media.license = store.getString(Prefs.DEFAULT_LICENSE, Prefs.Licenses.CC_BY_SA_3)
    ...
    private fun resolveMimeType(
        ...
        val mimeType = contribution.mimeType
        return if (mimeType == null || TextUtils.isEmpty(mimeType) || mimeType.endsWith("*")) {
    ...
    private fun resolveDataLength(
        ...
        try {
            if (contribution.dataLength <= 0) {
                ...
                val assetFileDescriptor = contentResolver.openAssetFileDescriptor(
                ...
                if (assetFileDescriptor != null) {
                    ...
                    return if (length != -1L) {
                        ...
                        countBytes(contentResolver.openInputStream(contribution.localUri))
                    }
                }
            }
        } catch (e: IOException) {
