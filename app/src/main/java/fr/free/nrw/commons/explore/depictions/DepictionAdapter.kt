...
class DepictionAdapter(private val onDepictionClicked: (DepictedItem) -> Unit) :
    PagedListAdapter<DepictedItem, DepictedItemViewHolder>(DepictedItemDiffUtilCallback) {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) = DepictedItemViewHolder(
        ItemDepictionsBinding.inflate(
...
private object DepictedItemDiffUtilCallback : DiffUtil.ItemCallback<DepictedItem>() {
...
class DepictedItemViewHolder(private val binding: ItemDepictionsBinding) :
