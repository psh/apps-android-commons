 ...
 */
private const val MEDIA_PARAMS_WITH_CATEGORY_DETAILS =
...
interface MediaInterface {
     ...
     * @return
     */
    @GET("w/api.php?action=query&format=json&formatversion=2&generator=allimages&gaisort=timestamp&gaidir=older$MEDIA_PARAMS")
