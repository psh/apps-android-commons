...
interface NotificationInterface {
    ...
    @GET(WikidataConstants.MW_API_PREFIX + "action=query&meta=notifications&notformat=model&notlimit=max")
    ...
    @FormUrlEncoded
    @Headers("Cache-Control: no-cache")
    @POST(WikidataConstants.MW_API_PREFIX + "action=echomarkread")
    fun markRead(
