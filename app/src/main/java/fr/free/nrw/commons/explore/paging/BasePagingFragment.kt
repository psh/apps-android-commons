...
abstract class BasePagingFragment<T> : CommonsDaggerSupportFragment(), PagingContract.View<T> {
    ...
    private val binding: FragmentSearchPaginatedBinding get() = _binding!!

    override fun onCreateView(
        inflater: LayoutInflater,
        container: ViewGroup?,
        savedInstanceState: Bundle?
    ) = FragmentSearchPaginatedBinding.inflate(inflater, container, false).also {
        _binding = it
    }.root
