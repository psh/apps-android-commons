...
//    def variantsList = android.hasProperty("applicationVariants") ?
//            android."applicationVariants" : android."libraryVariants"
//    variantsList.all {
//        variant -> configureVariant(variant)
//    }
//}
//
//private configureVariant(variant) {
...
//            "**/**/zoomControllers/*",]
//
//    tasks.create(name: "${unitTestTask}UnifiedCoverage", type: JacocoReport, dependsOn: ["$unitTestTask",
